...
describe Tweet do
  subject do
    ...
    Tweet.new(:event_created_at => DateTime.parse('Wed Aug 29 17:12:58 +0000 2012'),
              :tweet_id => '12345',
              :text => 'omg tweeting for teh win',
              :user_id => user.id)
  end

  it 'requires a event_created_at' do
  ...
  it 'requires a unique tweet_id' do
    expect {
      Tweet.create!(:event_created_at => DateTime.parse('Wed Aug 29 17:12:58 +0000 2012'),
                    :tweet_id => '12345',
                    :text => 'omg tweeting for teh win',
                    :user_id => 1)
