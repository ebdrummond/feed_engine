...
photo18 = Photo.create!(:taken_at => "2013-05-04 05:35:23", :photo_id => "gschool58", :caption => "slots slots slots slots", :user_id => user7.id, :url => "http://upload.wikimedia.org/wikipedia/en/8/82/Las_Vegas_slot_machines.jpg")
photo19 = Photo.create!(:taken_at => "2013-05-04 07:45:19", :photo_id => "gschool59", :caption => "wish me luck!", :user_id => user8.id, :url => "http://aussiecasinoonline.net.au/wp-content/uploads/2013/03/online-casino.jpg")
...
photo20 = Photo.create!(:taken_at => "2013-05-05 11:57:19", :photo_id => "gschool63", :caption => "Don't mind if I do", :user_id => user8.id, :url => "http://0.tqn.com/d/govegas/1/0/4/-/2/bellpool4.JPG")
...
photo21 = Photo.create!(:taken_at => "2013-05-05 12:43:19", :photo_id => "gschool65", :caption => "this place is unreal", :user_id => user7.id, :url => "http://lifescapesintl.com/libraries/images/portfolio/las-vegas-strip/vegas-7.jpg")
...
photo22 = Photo.create!(:taken_at => "2013-05-06 09:49:19", :photo_id => "gschool69", :caption => "I am starting to feel American", :user_id => user7.id, :url => "http://upload.wikimedia.org/wikipedia/commons/1/16/Las_Vegas_NY_NY_Hotel.jpg")
photo23 = Photo.create!(:taken_at => "2013-05-06 09:50:19", :photo_id => "gschool70", :caption => "I love this city", :user_id => user3.id, :url => "http://www.vegasnews.com/wp-content/uploads/Perez-girls-9-588.jpg")
photo24 = Photo.create!(:taken_at => "2013-05-06 09:51:19", :photo_id => "gschool71", :caption => "Never too early to get started in Vegas", :user_id => user3.id, :url => "http://www.ncbshow.com/files/ncbshow/nodes/2010/24/106.jpg")
...
photo25 = Photo.create!(:taken_at => "2013-05-07 09:57:19", :photo_id => "gschool76", :caption => "Not tacky at all", :user_id => user8.id, :url => "http://www.thelifeofluxury.com/images/venetian_resort_hotel_gondola.jpg")
...
photo26 = Photo.create!(:taken_at => "2013-05-07 09:58:32", :photo_id => "gschool80", :caption => "pool party!!!", :user_id => user3.id, :url => "http://www.ihookupvegas.com/wp-content/uploads/2010/10/tao-beach-las-vegas-pool-party.jpg")
photo27 = Photo.create!(:taken_at => "2013-05-07 09:59:32", :photo_id => "gschool81", :caption => "because why not?", :user_id => user8.id, :url => "http://media.lonelyplanet.com/lpi/25945/25945-3/681x454.jpg")
tweet38 = Tweet.create!(:tweeted_at => "2013-05-07 9:59:42", :tweet_id => "gschool82", :text => "just saw Elvis marrying a circus clown and a furry in a drive thru.  Oh Vegas.", :user_id => user4.id)
tweet39 = Tweet.create!(:tweeted_at => "2013-05-08 02:01:42", :tweet_id => "gschool83", :text => "Anyone else feeling like their liver is dying?", :user_id => user7.id)
tweet40 = Tweet.create!(:tweeted_at => "2013-05-08 02:02:42", :tweet_id => "gschool84", :text => "Nope!  Eat more kale (and drink less)!", :user_id => user8.id)
tweet41 = Tweet.create!(:tweeted_at => "2013-05-08 02:03:42", :tweet_id => "gschool85", :text => "@irish_burrito1 so very helpful", :user_id => user7.id)
checkin16 = CheckIn.create!(:checked_in_at => "2013-05-08 03:58:23", :check_in_id => "gschool86", :venue => Hashie::Mash.new({"id"=>"gschool86", "name"=>"The Roller Coaster", "contact"=>{"phone"=>"5032288131", "formattedPhone"=>"(503) 228-8131"}, "location"=>{"address"=>"3790 Las Vegas Blvd S", "postalCode"=>"89109", "city"=>"Las Vegas", "state"=>"NV", "country"=>"United States", "cc"=>"US"}, "canonicalUrl"=>"https://foursquare.com/v/the-roller-coaster/4a92b8b8f964a5206e1d20e3"}), :user_id => user4.id)
tweet42 = Tweet.create!(:tweeted_at => "2013-05-08 03:59:42", :tweet_id => "gschool87", :text => "gonna check out another casino.  No way in hell I'm getting on a roller coaster", :user_id => user7.id)
photo28 = Photo.create!(:taken_at => "2013-05-08 04:09:32", :photo_id => "gschool88", :caption => "Woooooo!!!!", :user_id => user3.id, :url => "http://www.thecoastercritic.com/wp-content/uploads/2013/02/El-Loco-Roller-Coaster-Adventuredome-Las-Vegas-Circus-Circus.jpg")
tweet43 = Tweet.create!(:tweeted_at => "2013-05-08 04:24:42", :tweet_id => "gschool89", :text => "@irish_burrito1 we missed youuuuuu.  You win anything?", :user_id => user4.id)
tweet44 = Tweet.create!(:tweeted_at => "2013-05-08 04:25:42", :tweet_id => "gschool90", :text => "@phil_er_up3 Finally.  Won $750 at the blackjack table", :user_id => user1.id)
photo29 = Photo.create!(:taken_at => "2013-05-08 04:26:32", :photo_id => "gschool91", :user_id => user4.id, :url => "http://sandiegofreepress.org/wp-content/uploads/2013/03/Las-Vegas-USA.jpg")
tweet45 = Tweet.create!(:tweeted_at => "2013-05-08 04:27:42", :tweet_id => "gschool92", :text => "@irish_burrito1 just won another $600 at roulette.  Luck of the Irish indeed.", :user_id => user8.id)
photo30 = Photo.create!(:taken_at => "2013-05-08 04:29:32", :photo_id => "gschool93", :caption => "I have literally no idea what I'm doing", :user_id => user8.id, :url => "http://media.lonelyplanet.com/lpi/24029/24029-4/681x454.jpg")
tweet46 = Tweet.create!(:tweeted_at => "2013-05-08 04:40:42", :tweet_id => "gschool94", :text => "Crap.  We lost @weiner_2013.  Almost made it through the trip without turning into The Hangover", :user_id => user4.id)
tweet47 = Tweet.create!(:tweeted_at => "2013-05-09 04:42:42", :tweet_id => "gschool95", :text => "@phil_er_up3 sorry!  Easy to lose track of time in a casino :)", :user_id => user4.id)
photo31 = Photo.create!(:taken_at => "2013-05-09 04:44:32", :photo_id => "gschool96", :caption => "tacky, but I'll miss it here", :user_id => user8.id, :url => "http://www.wallpele.com/wp-content/uploads/2013/03/Las-Vegas-HD-Wallpaper.jpg")
tweet48 = Tweet.create!(:tweeted_at => "2013-05-09 04:46:42", :tweet_id => "gschool97", :text => "one more night.  gotta make it count!", :user_id => user3.id)
checkin18 = CheckIn.create!(:checked_in_at => "2013-05-09 04:48:23", :check_in_id => "gschool98", :venue => Hashie::Mash.new({"id"=>"gschool98", "name"=>"Pure Nightclub", "contact"=>{"phone"=>"7027317873", "formattedPhone"=>"(702) 731-7873"}, "location"=>{"address"=>"3570 Las Vegas Blvd S", "postalCode"=>"89109", "city"=>"Las Vegas", "state"=>"NV", "country"=>"United States", "cc"=>"US"}, "canonicalUrl"=>"https://foursquare.com/v/pure-nightclub-las-vegas/4ae9b78bf964a520cdb521e3"}), :user_id => user7.id)
photo32 = Photo.create!(:taken_at => "2013-05-09 04:49:32", :photo_id => "gschool99", :caption => "not thinking about the trip back tomorrow", :user_id => user3.id, :url => "http://cdn.cnwimg.com/wp-content/uploads/2013/02/bottle-service.jpg")
photo33 = Photo.create!(:taken_at => "2013-05-09 04:50:32", :photo_id => "gschool100", :caption => "bye bye Vegas", :user_id => user4.id, :url => "http://assets.byways.org/asset_files/000/010/499/nighttimevegas.JPG?1258553474")
tweet49 = Tweet.create!(:tweeted_at => "2013-05-09 04:51:42", :tweet_id => "gschool106", :text => "back to real life :(", :user_id => user7.id)
...
ut17 = user3.user_trips.create!(:trip_id => trip4.id, :trip_role => "kreepr")
