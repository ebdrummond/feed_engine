...
tweet27 = Tweet.create!(:tweeted_at => "2013-05-04 03:52:23", :tweet_id => "gschool55", :text => "@weiner_2013 and the slots are ready to hit your wallet", :user_id => user7.id)
tweet28 = Tweet.create!(:tweeted_at => "2013-05-04 03:54:23", :tweet_id => "gschool56", :text => "@sussinct @birder sounds good!", :user_id => user1.id)
checkin1 = CheckIn.create!(:checked_in_at => "2013-05-04 05:07:23", :check_in_id => "gschool57", :venue => Hashie::Mash.new({"id"=>"gschool4", "name"=>"Bridgeport Brewing Company", "contact"=>{"phone"=>"5032413612", "formattedPhone"=>"(503) 241-3612"}, "location"=>{"address"=>"1313 NW Marshall Street", "postalCode"=>"97209", "city"=>"Portland", "state"=>"OR", "country"=>"United States", "cc"=>"US"}, "canonicalUrl"=>"https://foursquare.com/v/bridgeport-brewery--brewpub/40b13b00f964a52054f51ee3"}), :user_id => user2.id)
photo1 = Photo.create!(:taken_at => "2013-05-05 05:35:23", :photo_id => "gschool58", :caption => "this beer is so good!", :user_id => user10.id, :url => "http://s3-media1.ak.yelpcdn.com/bphoto/xvMqh1cmaS9gXqWd99TCwg/l.jpg")
photo2 = Photo.create!(:taken_at => "2013-05-05 07:45:19", :photo_id => "gschool59", :caption => "haha... keep Portland weird indeed!", :user_id => user1.id, :url => "http://onlyinthiscity.org/wp-content/uploads/2012/05/Darth-Vader-Playing-The-Bagpipes-While-Riding-A-Unicycle.jpg")
checkin2 = CheckIn.create!(:checked_in_at => "2013-05-05 09:38:23", :check_in_id => "gschool60", :venue => Hashie::Mash.new({"id"=>"gschool7", "name"=>"Doug Fir Lounge", "contact"=>{"phone"=>"5032319663", "formattedPhone"=>"(503) 231-9663"}, "location"=>{"address"=>"830 E Burnside St", "postalCode"=>"97214", "city"=>"Portland", "state"=>"OR", "country"=>"United States", "cc"=>"US"}, "canonicalUrl"=>"https://foursquare.com/v/doug-fir-lounge/43ba6040f964a520e62c1fe3"}), :user_id => user2.id, :text => "Hope this band is good.  Haven't heard of them yet.  Birches & Binary?")
tweet29 = Tweet.create!(:tweeted_at => "2013-05-05 11:52:24", :tweet_id => "gschool61", :text => "Well, Birches & Binary is turning out to be pretty good, but man I am beat.", :user_id => user1.id)
photo3 = Photo.create!(:taken_at => "2013-05-05 011:57:19", :photo_id => "gschool62", :caption => "goodnight Portland!", :user_id => user10.id, :url => "http://api.ning.com/files/phxkX8gfqaSDBo1hJX7tKTJu686cNw2Rqz36uFk20ILSahMhF8-G0sr2df6SNzVwKo1NjiCbBCAqaDg4Im9NLQjcarhszoX9/SchnitzerAtNightFrontWMC.jpg")
checkin3 = CheckIn.create!(:checked_in_at => "2013-05-05 09:38:23", :check_in_id => "gschool63", :venue => Hashie::Mash.new({"id"=>"gschool10", "name"=>"Voodoo Doughnut", "contact"=>{"phone"=>"5032414704", "formattedPhone"=>"(503) 241-4704"}, "location"=>{"address"=>"22 SW 3rd Ave", "postalCode"=>"97204", "city"=>"Portland", "state"=>"OR", "country"=>"United States", "cc"=>"US"}, "canonicalUrl"=>"https://foursquare.com/v/voodoo-doughnut/42829c80f964a5201b221fe3"}), :user_id => user1.id, :text => "Yum!!!")
tweet30 = Tweet.create!(:tweeted_at => "2013-05-05 9:42:52", :tweet_id => "gschool64", :text => "Hardest part about eating at @VoodooDoughnut: picking just one.", :user_id => user2.id)
